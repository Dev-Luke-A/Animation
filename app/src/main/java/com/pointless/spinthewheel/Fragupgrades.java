...
public class Fragupgrades extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button Button1 = getView().findViewById(R.id.button);
        ...
        TextView textview2 = getView().findViewById(R.id.textView9);
        ...
        Button b09 = getView().findViewById(R.id.button);
        ...
        Button b99 = getView().findViewById(R.id.button3);
